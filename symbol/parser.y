...
%token WHILE IF RETURN PREPROC LE STRING PRINT FUNCTION DO ARRAY ELSE STRUCT STRUCT_VAR FOR GE EQ NE INC DEC DEFAULT BREAK CASE SWITCH
%right '='
...
switch : SWITCH '(' expr1 ')'  '{' CASE expr1 ':' StmtList  StmtList'}'
	;
